            ...
            <ScrollReveal animation="fade-right" delay={0}>
                <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-tertiary/50 transition-all h-full relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="font-bold text-primary text-xl md:text-2xl">{isAr ? 'فرع المملكة العربية السعودية' : 'Saudi Arabia Branch'}</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                         <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="tel:+966532425777" className="text-gray-800 font-bold hover:text-tertiary dir-ltr block text-left text-sm md:text-lg">+966 53 242 5777</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@firstair-sa.com" className="text-gray-800 font-bold hover:text-tertiary block break-all text-sm md:text-lg">info@firstair-sa.com</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-800 font-medium text-sm md:text-lg">{isAr ? 'حي الربوة – الرياض' : 'Al-Rabwa Dist – Riyadh'}</p>
                            </div>
                         </div>
                    </div>
                </div>
            ...
            <ScrollReveal animation="fade-left" delay={150}>
                <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-tertiary/50 transition-all h-full relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="font-bold text-primary text-xl md:text-2xl">{isAr ? 'فرع جمهورية مصر العربية' : 'Egypt Branch'}</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                         <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-xs text-gray-500 mb-1">{isAr ? 'الهاتف' : 'Phone'}</p>
                                <a href="tel:01065550024" className="text-gray-800 font-bold hover:text-tertiary dir-ltr block text-left text-sm md:text-lg">01065550024</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            <i className="fas fa-envelope mt-1 text-tertiary"></i>
                            <div>
                                <p className="text-xs text-gray-500 mb-1">{isAr ? 'البريد الإلكتروني' : 'Email'}</p>
                                <a href="mailto:info@firstair-eg.com" className="text-gray-800 font-bold hover:text-tertiary block break-all text-sm md:text-lg">info@firstair-eg.com</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            <i className="fas fa-location-arrow mt-1 text-tertiary"></i>
                            <div>
                                <p className="text-xs text-gray-500 mb-1">{isAr ? 'العنوان' : 'Address'}</p>
                                <p className="text-gray-800 font-medium text-sm md:text-lg">{isAr ? 'الطريق البطيء – المنطقة الصناعية – قليوب' : 'Slow Road – Industrial Zone – Qalyub'}</p>
                            </div>
                         </div>
                    </div>
                </div>
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                     ...
                     <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4 flex-wrap px-4">
                        <a 
                            ...
                            target="_blank" 
                            rel="noreferrer" 
                            className="bg-white text-primary px-6 py-3 rounded-lg font-bold text-sm shadow-md hover:bg-gray-100 transition flex-1 text-center whitespace-nowrap"
                        >
