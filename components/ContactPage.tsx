      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <ScrollReveal animation="fade-right" delay={0}>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-tertiary/50 transition-all h-full relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                         <img src="https://flagcdn.com/w160/sa.png" alt="KSA" className="w-24 rounded shadow-md" />
                    </div>
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="font-bold text-primary text-xl">{isAr ? 'فرع المملكة العربية السعودية' : 'Saudi Arabia Branch'}</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                         <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm text-gray-500 mb-1">{isAr ? 'الهاتف' : 'Phone'}</p>
                                <a href="tel:+966532425777" className="text-gray-800 font-bold hover:text-tertiary dir-ltr block text-left">+966 53 242 5777</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            <i className="fas fa-envelope mt-1 text-tertiary"></i>
                            <div>
                                <p className="text-sm text-gray-500 mb-1">{isAr ? 'البريد الإلكتروني' : 'Email'}</p>
                                <a href="mailto:info@firstair-sa.com" className="text-gray-800 font-bold hover:text-tertiary block break-all">info@firstair-sa.com</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            <i className="fas fa-location-arrow mt-1 text-tertiary"></i>
                            <div>
                                <p className="text-sm text-gray-500 mb-1">{isAr ? 'العنوان' : 'Address'}</p>
                                <p className="text-gray-800 font-medium">{isAr ? 'حي الربوة – الرياض' : 'Al-Rabwa Dist – Riyadh'}</p>
                            </div>
                         </div>
                    </div>
                </div>
            ...
            <ScrollReveal animation="fade-left" delay={150}>
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-tertiary/50 transition-all h-full relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                         <img src="https://flagcdn.com/w160/eg.png" alt="Egypt" className="w-24 rounded shadow-md" />
                    </div>
                    <div className="flex items-center gap-4 mb-6">
                        <div className="w-12 h-12 bg-red-600/10 rounded-full flex items-center justify-center text-red-600 text-xl flex-shrink-0">
                            <i className="fas fa-map-marked-alt"></i>
                        </div>
                        <h3 className="font-bold text-primary text-xl">{isAr ? 'فرع جمهورية مصر العربية' : 'Egypt Branch'}</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                         <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-sm text-gray-500 mb-1">{isAr ? 'الهاتف' : 'Phone'}</p>
                                <a href="tel:01065550024" className="text-gray-800 font-bold hover:text-tertiary dir-ltr block text-left">01065550024</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            <i className="fas fa-envelope mt-1 text-tertiary"></i>
                            <div>
                                <p className="text-sm text-gray-500 mb-1">{isAr ? 'البريد الإلكتروني' : 'Email'}</p>
                                <a href="mailto:info@firstair-eg.com" className="text-gray-800 font-bold hover:text-tertiary block break-all">info@firstair-eg.com</a>
                            </div>
                         </div>
                         <div className="flex items-start gap-3">
                            <i className="fas fa-location-arrow mt-1 text-tertiary"></i>
                            <div>
                                <p className="text-sm text-gray-500 mb-1">{isAr ? 'العنوان' : 'Address'}</p>
                                <p className="text-gray-800 font-medium">{isAr ? 'الطريق البطيء – المنطقة الصناعية – قليوب' : 'Slow Road – Industrial Zone – Qalyub'}</p>
                            </div>
                         </div>
                    </div>
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            <ScrollReveal animation="fade-up" delay={200}>
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100 relative overflow-hidden h-full">
                    <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary to-tertiary"></div>
                    
                    <h2 className="text-2xl font-bold text-primary mb-8">{isAr ? 'أرسل لنا استفسارك' : 'Send us an inquiry'}</h2>
            ...
            <ScrollReveal animation="fade-up" delay={300}>
                <div className="rounded-3xl overflow-hidden shadow-lg h-full min-h-[400px] bg-gray-200 relative group">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                     ...
                     <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4">
                        <a 
                            ...
                            target="_blank" 
                            rel="noreferrer" 
                            className="bg-white text-primary px-4 py-2 rounded-lg font-bold text-sm shadow-md hover:bg-gray-100 transition"
                        >
