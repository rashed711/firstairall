      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-20">
            ...
            <div className="w-full lg:w-1/2">
                <ScrollReveal animation="fade-left" delay={200}>
                    <h2 className="text-sm font-bold text-tertiary uppercase tracking-wider mb-2">{isAr ? 'عن الشركة' : 'Company Profile'}</h2>
                    <h3 className="text-3xl font-extrabold text-primary mb-6">{isAr ? 'خبرة ممتدة في السوق المصري والسعودي' : 'Extensive Experience in Egyptian & Saudi Markets'}</h3>
                    ...
                    <div className="grid grid-cols-2 gap-6 mt-8">
                        ...
                        <div className="border-l-4 border-tertiary pl-4 rtl:border-l-0 rtl:border-r-4 rtl:pr-4">
                            <span className="block text-3xl font-bold text-primary mb-1">MEP</span>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
            <ScrollReveal animation="fade-up" className="h-full">
                <div className="bg-gray-50 p-10 rounded-3xl border border-gray-100 hover:shadow-xl transition-shadow h-full">
                    ...
                    <h3 className="text-2xl font-bold text-primary mb-4">{isAr ? 'تواجدنا في السعودية' : 'Presence in KSA'}</h3>
            ...
            <ScrollReveal animation="fade-up" delay={200} className="h-full">
                <div className="bg-primary text-white p-10 rounded-3xl border border-primary hover:shadow-xl transition-shadow h-full">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4">{isAr ? 'فلسفتنا' : 'Our Philosophy'}</h3>
        ...
        <div className="text-center mb-16">
            <ScrollReveal animation="fade-up">
                <h2 className="text-3xl font-bold text-primary mb-12">{isAr ? 'قطاعات الأعمال' : 'Business Sectors'}</h2>
            </ScrollReveal>
